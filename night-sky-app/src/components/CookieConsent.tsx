              ...
              <div className="cookie-category">
                ...
                <div className="cookie-category-description-wrapper">
                  ...
                  <ul className="cookie-examples-list">
                    ...
                    <li>Security cookies for protecting against fraudulent activity</li>
              ...
              <div className="cookie-category">
                ...
                <div className="cookie-category-description-wrapper">
                  <p className="cookie-category-description">
                    ...
                    individual users, thereby making them more valuable for
                  ...
                  <ul className="cookie-examples-list">
                    ...
                    <li>Retargeting campaigns across different platforms</li>
                  ...
                  <p className="cookie-category-description">
                    <em>Third-party providers may include: Google Ads, Facebook Pixel, LinkedIn Insight Tag.</em>
                  </p>
                </div>
              </div>
